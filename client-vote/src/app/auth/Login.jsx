    ...
    return (<>
        ...
        <div class="pt-6 sm:pt-8 lg:pt-12">
            <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
                ...
                <p   class="mb-2 text-center font-semibold text-indigo-500 md:mb-3 lg:text-lg">login</p>

                <h2 class="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-6 lg:text-3xl">Login</h2>
